    ...
    return (
        ...
        <div className=' bg-linear-gradienttwo pb-6 '>
            ...
            <div className=' flex  pt-10 z-10'>
                ...
                <div className='flex flex-col justify-center  w-full'>
                    <div className='  pl-20 rounded-md  text-white' >
                        <h1 className='text-lime-400 text-xl  '>Dr. Google V.2</h1>
                        <br/>
                        <h1 className='font-bolder text-4xl'>Get A Sensation Like Flying</h1>
            ...
            <div className=' flex  pt-10 z-10'>
                <div className='flex flex-col justify-center  w-full'>
                    <div className='  pl-20 rounded-md  text-white' >
                        ...
                        <br/>
                        <h1 className='font-bolder text-4xl'>Enjoy Driving In The Sky</h1>
            ...
            <div className=' flex pt-10 z-10'>
                ...
                <div className='flex flex-col justify-center  w-full'>
                    <div className='  pl-20 rounded-md  text-white' >
                        <h1 className='text-lime-400 text-xl'>DR Avata V.2</h1>
                        <br/>
                        <h1 className='font-bolder text-4xl'>Where Agility Meets Thoughness</h1>
